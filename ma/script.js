...
const pdfFiles = [
  ...
  { name: "3)A) Relative Layout = Create a android application to design screen's using different layout and UI including button, text, text view, radio button etc", path: "3)A) Relative Layout = Create a android application to design button txt view.txt" },
